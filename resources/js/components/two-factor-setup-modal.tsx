...
export default function TwoFactorSetupModal({
  ...
  const modalConfig = useMemo<{
    ...
    if (twoFactorEnabled) {
      return {
        title: 'Autenticação de dois fatores está habilitada',
        description:
          'A autenticação de dois fatores está agora habilitada. Digitalize o código QR ou insira a chave de configuração em seu aplicativo autenticador.',
        buttonText: 'Fechar',
      };
    }
    ...
    return {
      ...
      description:
        'Para finalizar a activação da autenticação de dois fatores, digitalize o código QR ou insira a chave de configuração em seu aplicativo autenticador',
      buttonText: 'Continuar',
    };
