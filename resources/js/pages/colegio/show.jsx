...
import {
    show,
} from '@/actions/App/Http/Controllers/Colegios/CursoTuteladoController';
...
export default function Show({
    ...
    const handlePageChange = (page) => {
        router.get(route('colegios.show', {
        ...
        <div className="mx-auto w-full max-w-7xl space-y-4 p-6">
            <Card className="gap-0">
                <CardHeader className="border-b">
                    ...
                    <CardDescription>Cursos Tutelados ygvygvuyg</CardDescription>
                </CardHeader>
                ...
                <TablePagination pagination={cursos}
