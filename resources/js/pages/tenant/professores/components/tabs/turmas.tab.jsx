...
export function TurmasTab({ turmas }) {
  ...
  return (
    <Card className="gap-0">
      <CardHeader className="border-b">
        ...
        <CardDescription>Turmas lecionadas por este professor</CardDescription>
      </CardHeader>
      ...
      <CardContent className="p-0!">
        {isEmpty ? (
          <EmptyState
            ...
            description="Comece adicionando turmas a este professor"
          />
        ) : (
          <Table>
            <TableHeader>
