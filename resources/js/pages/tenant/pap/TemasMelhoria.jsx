...
export default function TemasParaCorrigir({ temas = [], rotaEditar }) {
  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        <h1 className="text-3xl font-bold">Temas PAP Pendentes de Correção</h1>

        <p className="mt-1 text-gray-600">
          Consulte o motivo da instituição tutora, corrija ou substitua o tema e
      ...
      {temas.length === 0 ? (
        ...
        <div className="space-y-6">
          {temas.map((tema) => {
            const config =
              STATUS_CONFIG[tema.status_aprovacao] ??
            ...
            return (
              <div key={tema.id} className="space-y-4">
                ...
                <RecomendacaoBox comentario={tema.comentario_aprovacao} />
                ...
                <div className="flex justify-end">
                  ...
                  >
                    {loading === tema.id ? 'A abrir...' : config.botao}
                  </Button>
                </div>
              </div>
            );
