...
const ESTADO_CONFIG = {
  'melhoria-solicitada': { label: 'Melhoria solicitada', className: 'bg-yellow-100 text-yellow-800' },
...
export default function RecomendacaoBox({ comentario, autor, data, estado }) {
  const config = ESTADO_CONFIG[estado] ?? { label: estado, className: 'bg-gray-100 text-gray-800' };
