...
export default function LancamentosRecursoTable({ alunos = [], onSubmit, isPending }) {
    ...
    function handleSubmit() {
        const lancamentos = alunos.map(aluno => ({
            ...
            tdp_id: aluno.tdp_id,
            nota_recurso: notas[aluno.turma_aluno_id] !== ''
        ...
        <Card className="gap-0">
            <CardHeader className="border-b">
                <div>
                    ...
                    <CardDescription>Alunos com média final entre 7 e 9.5</CardDescription>
                </div>
                <CardAction>
                            ...
                            {alunos.map((aluno, index) => {
                                ...
                                return (
                                    <TableRow key={aluno.turma_aluno_id}>
                                        ...
                                        <TableCell className="px-4 text-center text-destructive font-medium">
