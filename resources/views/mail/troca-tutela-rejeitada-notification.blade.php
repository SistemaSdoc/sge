...
<head>
    ...
    <title>Troca de tutela rejeitada</title>
...
<body>
    ...
    <div class="email-wrapper">
        ...
        <p style="padding: 12px 24px 20px; font-size: 14px; line-height: 1.6; color: #202124;">
            O <strong>{{ $nomeInstituicaoRejeitou }}</strong> rejeitou o pedido para transferir a tutela
            do curso <strong>{{ $nomeCurso }}</strong> para o <strong>{{ $nomeInstituicaoProposta }}</strong>.
