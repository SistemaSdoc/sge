                        ...
                        <tbody>
                            <tr style="width:100%">
                                <td>
                                    ...
                                    <p style="font-size:14px;line-height:24px;color:rgb(0,0,0);margin:16px 0">
                                        Tens <strong>{{ $totalMeses }} mês(es)</strong> de propina em atraso.
                                        Por favor, regulariza a tua situação o mais breve possível.
                                    </p>
                                    ...
                                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <p style="font-size:13px;line-height:24px;margin:0;color:rgb(102,102,102)">Meses em atraso</p>
                                                    <p style="font-size:14px;line-height:24px;margin:0 0 12px;font-weight:600;color:rgb(0,0,0)">
                                                        {{ implode(', ', $meses) }}
                                                    </p>

                                                    <p style="font-size:13px;line-height:24px;margin:0;color:rgb(102,102,102)">Total em dívida</p>
                                                    <p style="font-size:14px;line-height:24px;margin:0;font-weight:600;color:rgb(220,38,38)">
                                                        {{ $valorTotal }} AOA
                                                    </p>
                                                </td>
                                            </tr>
