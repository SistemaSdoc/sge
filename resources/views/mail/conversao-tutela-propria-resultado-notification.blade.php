...
<body>
    ...
    <div class="email-wrapper">
        ...
        <p style="padding: 12px 24px 20px; font-size: 14px; line-height: 1.6; color: #202124;">
            A <strong>{{ $nomeInstituicaoSolicitante }}</strong> solicitou deixar de ter tutela externa
            no curso <strong>{{ $nomeCurso }}</strong>.
            Entre na plataforma para aprovar ou rejeitar esta conversão.
        </p>

        <div class="cta-wrapper">
            <a href="{{ $url }}" class="cta-button" target="_blank">Analisar solicitação</a>
        </div>
