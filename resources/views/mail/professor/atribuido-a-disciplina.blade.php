                        ...
                        <tbody>
                            <tr style="width:100%">
                                <td>
                                    ...
                                    <p style="font-size:14px;line-height:24px;color:rgb(0,0,0);margin:16px 0">
                                        Foi atribuído como professor à seguinte disciplina:
                                    </p>
                                    ...
                                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <p style="font-size:13px;line-height:24px;margin:0;color:rgb(102,102,102)">Disciplina</p>
