...
<head>
    ...
    <title>Tema aprovado no PAP</title>
...
<body>
    ...
    <div class="email-wrapper">
        ...
        <p style="padding: 12px 24px 20px; font-size: 14px; line-height: 1.6; color: #202124;">
            O tema do vosso grupo PAP foi <strong>aprovado pela coordenação</strong>.
        ...
        @if($comentario)
            <div class="feedback-box">
                <div class="feedback-label">Observações</div>
                <p>{{ $comentario }}</p>
            </div>
        @endif
