...
<head>
    ...
    <title>Tema definido no PAP</title>
...
<body>
    ...
    <div class="email-wrapper">
        ...
        <p style="padding: 12px 24px 20px; font-size: 14px; line-height: 1.6; color: #202124;">
            O tema do grupo <strong>{{ $nomeGrupo }}</strong> foi definido com sucesso.
        </p>
        ...
        <div class="info-card">
            ...
            @if(isset($professorTutor))
                <div class="card-item">
                    <div class="card-label">Professor tutor</div>
                    <div class="card-value">{{ $professorTutor }}</div>
                </div>
            @endif
        </div>
