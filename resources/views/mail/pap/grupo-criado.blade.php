...
<div
    ...
    O grupo PAP {{ $nomeGrupo }} foi criado com sucesso.
</div>
                    ...
                    <tbody>
                        <tr style="width:100%">
                            <td>
                                ...
                                <!-- Elementos do grupo -->
                                <p
                                    style="font-size:13px;line-height:24px;margin-top:16px;margin-bottom:8px;color:rgb(102,102,102)">
                                    Elementos do grupo
                                </p>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <ul
                                                    style="margin-top:0;margin-bottom:0;padding-left:18px">

                                                    @foreach($alunos as $aluno)

                                                        <li
                                                            style="font-size:14px;line-height:22px;color:rgb(0,0,0);margin-top:6px;margin-bottom:6px">
                                                            {{ $aluno }}
                                                        </li>
