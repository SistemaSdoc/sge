...
<head>
    ...
    <title>Trabalho recebido pela coordenação</title>
...
<body>
    <div class="email-wrapper">
        ...
        <p style="padding: 12px 24px 20px; font-size: 14px; line-height: 1.6; color: #202124;">
            O trabalho do grupo <strong>{{ $nomeGrupo }}</strong> foi submetido com sucesso e está agora em análise pela coordenação.
            Aguarde a revisão e a próxima decisão.
        </p>
