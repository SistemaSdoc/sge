...
<div
    ...
    Foi convocado para integrar a banca de júri do grupo PAP.
</div>
                    ...
                    <tbody>
                        <tr style="width:100%">
                            <td>
                                ...
                                <p
                                    style="font-size:14px;line-height:24px;color:rgb(0,0,0);margin-top:16px;margin-bottom:16px">
                                    Foi convocado como <strong>{{ $funcao }}</strong> na banca de júri do grupo
                                    abaixo.
                                </p>
