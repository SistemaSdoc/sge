...
<head>
    ...
    <title>Nota PAP atribuída</title>
    ...
    <style>
        * {
        ...
        .info-card .card-value.nota {
            font-size: 28px;
            font-weight: 700;
            line-height: 1.2;
        }

        .info-card .card-value.nota span {
            font-size: 14px;
            font-weight: 400;
            color: #5f6368;
        }
...
<body>
    ...
    <div class="email-wrapper">
        ...
        <p style="padding: 12px 24px 20px; font-size: 14px; line-height: 1.6; color: #202124;">
            A tua nota individual do PAP foi <strong>atribuída com sucesso</strong>.
        </p>
