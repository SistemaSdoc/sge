...
<div
    ...
    Foi solicitada uma correcção no trabalho do grupo PAP. Consulte o feedback e reenvie o trabalho após as alterações.
</div>
                    ...
                    <tbody>
                        <tr style="width:100%">
                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <h1
                                                    ...
                                                    Correcção solicitada no trabalho PAP
                                                </h1>
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <p
                                    style="font-size:14px;line-height:24px;color:rgb(0,0,0);margin-top:16px;margin-bottom:16px">
                                    O <strong>{{ $solicitadoPor }}</strong> solicitou uma correcção no trabalho do
                                    vosso grupo PAP. Consulte o feedback e reenvie o trabalho quando estiver
                                    corrigido.
                                </p>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <p
                                                    style="font-size:13px;line-height:24px;margin-top:0;margin-bottom:4px;color:rgb(102,102,102)">
                                                    Grupo
                                                </p>
