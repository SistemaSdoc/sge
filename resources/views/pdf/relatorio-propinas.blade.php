...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .badge-alerta   { background: #f3e3e3; color: #7a2e2e; border-color: #d9b8b8; }
  .badge-atencao  { background: #f2ead8; color: #7a5c1e; border-color: #ddc99a; }
  .badge-leve     { background: #f0eed8; color: #6b6320; border-color: #d9d19a; }
  .badge-em-dia   { background: #e2e9e2; color: #365036; border-color: #b9ccb9; }
...
<body>
  ...
  @if(count($emDia) === 0)
    <p class="sem-registos">Nenhum aluno desta turma está em dia.</p>
  @else
