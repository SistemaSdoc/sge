...
class VerificarPropinaEmDia
{
    ...
    /**
     * Rotas que devem continuar acessíveis mesmo com o aluno bloqueado.
     * Sem isto, o aluno em atraso nunca consegue interagir com as
     * próprias notificações (marcar como lida fica sempre a devolver
     * a página de bloqueio em vez de executar a ação).
     */
    ...
    {
        if ($request->routeIs(self::ROTAS_ISENTAS)) {
            Log::debug('[VerificarPropinaEmDia] ROTA ISENTA — libera acesso', [
